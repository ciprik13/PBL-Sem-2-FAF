    ...
    data.forEach(item => {
        ...
        Object.entries(item).forEach(([key, value]) => {
            ...
            if (key.toLowerCase().includes('status')) {
                // Create a span element for status to keep the same layout as original table
                ...
                // If there were any other specific wrappers or classes applied to the cells, replicate that here
                cell.textContent = value;
            }
            row.appendChild(cell);
        });
